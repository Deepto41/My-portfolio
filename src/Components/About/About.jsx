...
const About = () => {
  return (
    <section id="about" className="mt-20 px-4 md:px-8 lg:px-20  w-11/12 mx-auto">
      ...
      {/* Description */}
      <div className="mt-6 text-center text-base sm:text-lg md:text-xl leading-relaxed md:leading-loose text-gray-700 dark:text-gray-300">
        <p>
          ...
          sharpening my skills in the MERN stack through Programming Hero.
          I’ve focused on gaining hands-on experience and deepening my knowledge
        ...
        <p className="mt-4">
          Beyond programming, I have a love for solving math problems —
          numbers and logic have always fascinated me.
        </p>
